 ...
 *
 * This file implements the logging functionality for the ldsgen library
...
namespace ldsgen {
    ...
    auto make_file_logger() noexcept -> std::shared_ptr<spdlog::logger> {
        auto l = spdlog::basic_logger_mt("file_logger", "ldsgen.log");
     ...
     *
     * This function creates a file logger that writes to "ldsgen.log",
    ...
    void log_with_spdlog(const std::string& message) {
        ...
        spdlog::info("LdsGen message: {}", message);
    }
